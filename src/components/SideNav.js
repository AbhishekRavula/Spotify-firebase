  ...
  return (
    <div id="left_nav">
      <ul id="sideNav">
        ...
        <li onClick={() => history.push("/collection/playlists")}>
          <LibraryMusicRoundedIcon /> Library
        </li>
        <li onClick={routeNewPlaylist}>
          <PlaylistAddRoundedIcon /> Create Playlist
        </li>
        <li onClick={() => history.push("/collection/musics")}>
          <FavoriteRoundedIcon /> Liked Songs
        </li>
      </ul>
      <hr
        style={{
      ...
      {visibleContextMenu && (
        <PlaylistContextMenu
          ...
          changeVisibleContextMenu={changeVisibleContextMenu}
        />
      )}
    </div>
  );
  ...
  return (
    <div style={contextMenuStyle} ref={domNode}>
      <li
        ...
        onClick={() =>
          deletePlaylist(
            props.contextMenu.playlistId,
            props.changeVisibleContextMenu
          )
        }
      >
        Delete

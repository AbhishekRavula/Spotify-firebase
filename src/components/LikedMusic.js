  ...
  return (
    <div>
      <div id="playlistHeader">
        <img
          id="image"
          src="https://i.pinimg.com/originals/db/f0/98/dbf098866a153bc938dce016f180e397.jpg"
          alt="playlistCover"
        ></img>
        ...
        return (
          <div>
            <Song
              ...
              song={song.url}
              index={index + 1}
              updateLikedMusicData={updateLikedMusicData}
              playState={props.playState}
              updateMusicData={props.updateMusicData}
            />
          </div>
        );
      })}
